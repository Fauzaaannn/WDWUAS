<template>
  ...
  <div id="iklan" class="container">
    <div class="row">
      ...
      <router-link to="/Preview" class="card mt-5 mx-4 rounded-4 col-sm-2 border-0 shadow" style="text-decoration: none;">
        <div class="px-1 pt-3">
          <img src="../assets/hudie.jpeg" class="card-img-top rounded-4" alt="...">
          <div class="card-body p-0 mt-3 mb-3">
            <h5 class="card-title">Bomber Jacket</h5>
            <h4 class="card-title mt-2 mb-2">Rp100.000</h4>
            <p class="card-text mb-2">Kota Surabaya</p>
      ...
      <router-link to="/Preview" class="card mt-5 mx-4 rounded-4 col-sm-2 border-0 shadow" style="text-decoration: none;">
        <div class="px-1 pt-3">
          <img src="../assets/hudiput.jpeg" class="card-img-top rounded-4" alt="...">
          <div class="card-body p-0 mt-3 mb-3">
            <h5 class="card-title">Bomber Jacket</h5>
            <h4 class="card-title mt-2 mb-2">Rp100.000</h4>
            <p class="card-text mb-2">Kota Surabaya</p>
      ...
      <router-link to="/Preview" class="card mt-5 mx-4 rounded-4 col-sm-2 border-0 shadow" style="text-decoration: none;">
        <div class="px-1 pt-3">
          <img src="../assets/jeans.jpeg" class="card-img-top rounded-4" alt="...">
          <div class="card-body p-0 mt-3 mb-3">
            <h5 class="card-title">Bomber Jacket</h5>
            <h4 class="card-title mt-2 mb-2">Rp100.000</h4>
            <p class="card-text mb-2">Kota Surabaya</p>
    ...
    <div class="row">
      <router-link to="/Preview" class="card mt-5 mx-4 rounded-4 col-sm-2 border-0 shadow" style="text-decoration: none;">
        <div class="px-1 pt-3">
          <img src="../assets/shirts.jpeg" class="card-img-top rounded-4" alt="...">
          <div class="card-body p-0 mt-3 mb-3">
            <h5 class="card-title">Bomber Jacket</h5>
            <h4 class="card-title mt-2 mb-2">Rp100.000</h4>
            <p class="card-text mb-2">Kota Surabaya</p>
